...
class HandlersUserSignupData(BaseModel):
    """
    ...
    invite_token: Optional[StrictStr] = Field(default=None, description="Optional invite token for signup", alias="inviteToken")
    last_name: StrictStr = Field(alias="lastName")
    password: Annotated[str, Field(min_length=8, strict=True, max_length=32)]
    __properties: ClassVar[List[str]] = ["confirmPassword", "email", "firstName", "inviteToken", "lastName", "password"]
