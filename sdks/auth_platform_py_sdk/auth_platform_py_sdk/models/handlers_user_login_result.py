...
class HandlersUserLoginResult(BaseModel):
    """
    HandlersUserLoginResult
    """ # noqa: E501
    flow_id: Optional[StrictStr] = Field(default=None, alias="flowId")
    message: Optional[StrictStr] = None
    require_email_verification: Optional[StrictBool] = Field(default=None, alias="requireEmailVerification")
    tokens: Optional[TokensTokens] = None
    __properties: ClassVar[List[str]] = ["flowId", "message", "requireEmailVerification", "tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "requireEmailVerification": obj.get("requireEmailVerification"),
            "tokens": TokensTokens.from_dict(obj["tokens"]) if obj.get("tokens") is not None else None
        })
        return _obj
